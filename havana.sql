...
--
-- Hôte : localhost
-- Généré le : lun. 07 mars 2022 à 10:28
...
(29, 'claquette havana'),
(33, 'testde la categorie a qui correspond a 1');
...
CREATE TABLE `commandes` (
  ...
  `nom_commande` varchar(250) NOT NULL,
...
INSERT INTO `country` (`id`, `phone_code`, `code_country`, `country`) VALUES
(1, 93, 'AF', 'Afghanistan'),
...
(14, 'produit ', 'test', 12, 23, 11, 4, 1, '/images/test.png', '100'),
(20, 'jesuisun arbre', 'sasa', 25, 28, 10, 2, 1, 'codeproduction.jpeg', '45');
...
(1, 'samirgonzalez1315@gmail.com', 11078344, 4),
(2, 'samirgonzalez1315@gmail.com', 57074680, 4);
...
INSERT INTO `utilisateurs` (`id_utilisateur`, `firstname`, `lastname`, `mail`, `password`, `phone`, `country_code`, `address`, `birthday`, `avatar`, `admin`) VALUES
(1, 'Sam', 'Belhadj', 's@s.s', 'c045c9838ba93fe23b0842c44195bfbd7298d35d', 102030405, 'DZ', NULL, '1999-07-01', 'avatar.png', 0);
...
ALTER TABLE `commandes`
  ...
  ADD KEY `id_utilisateur` (`id_test`);
...
--
ALTER TABLE `commandes`
  ADD CONSTRAINT `commandes_ibfk_1` FOREIGN KEY (`id_test`) REFERENCES `utilisateurs` (`id_utilisateur`);

--
-- Contraintes pour la table `commentaires`
--
ALTER TABLE `commentaires`
  ADD CONSTRAINT `commentaires_ibfk_1` FOREIGN KEY (`id_produit`) REFERENCES `produit` (`id_produit`) ON DELETE CASCADE,
  ADD CONSTRAINT `commentaires_ibfk_2` FOREIGN KEY (`id_test`) REFERENCES `utilisateurs` (`id_utilisateur`) ON DELETE CASCADE;
