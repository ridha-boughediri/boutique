...
--
-- Hôte : localhost
-- Généré le : mar. 26 avr. 2022 à 13:41
...
CREATE TABLE `paiement` (
  ...
  `total_achat` float(10,2) NOT NULL,
...
(29, 'Havaianas Top Logomania Mid Tech', 'test', 25.00, 26, 11, 2, 1, '714609.jpg', '50'),
(31, 'Havaianas Top Logomania Mid Tech', 'undefined', 25.00, 26, 14, 3, 2, '205006.jpg', '45'),
...
(13, 'super', 'admin', 'admin@gmail.com', '8cb2237d0679ca88db6464eac60da96345513964', 0, 'nice', 34000, NULL, '2022-03-28', 'avatar.png', 1),
...
--
ALTER TABLE `paiement`
  ADD CONSTRAINT `paiement_ibfk_1` FOREIGN KEY (`id_utilisateur`) REFERENCES `utilisateurs` (`id_utilisateur`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `paiement_ibfk_2` FOREIGN KEY (`id_panier`) REFERENCES `panier` (`id_panier`) ON DELETE CASCADE;
