$(document).ready(function () {
  ...
  $(".order").on("click", function () {
    var order =
      '<h1 class="title-main" style="color: #fb373c; text-decoration: underline #fb373c; margin-bottom: 1vh;">Vos Commandes</h1><p>Aucune Commande</p>';
  ...
  $(".pay").on("click", function () {
    var pay =
      '<h1 class="title-main" style="color: #fb373c; text-decoration: underline #fb373c; margin-bottom: 1vh;">Vos Paiement</h1>';
    $(".view-container").empty();
