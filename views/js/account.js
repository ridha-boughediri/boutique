$(document).ready(function () {
  $(".submit-edit-profile").click(function (e) {
    ...
    $.ajax({
      url: "./processing/process_edit_profile.php",
      type: "post",
      data: fd,
      contentType: false,
      processData: false,
...
$(".order").on("click", function () {
  ...
  var order = '<h1 class="title-main" style="color: burlywood; text-decoration: underline burlywood; margin-bottom: 1vh;">Vos Commandes</h1><p>Aucune Commande</p>';
...
$(".adress").on("click", function () {
  ...
  var adress = '<h1 class="title-main" style="color: burlywood; text-decoration: underline burlywood; margin-bottom: 1vh;">Adresse</h1>';
  $(".view-container").empty();
...
$(".pay").on("click", function () {
  ...
  var pay = '<h1 class="title-main" style="color: burlywood; text-decoration: underline burlywood; margin-bottom: 1vh;">Vos Paiement</h1>';
  $(".view-container").empty();
